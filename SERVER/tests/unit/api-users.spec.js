...
describe("POST /api/SignUp", () => {
  it("should create a new user", async () =>{
    console.log("Test Case 1: should create a new user");
    // console.log(newUser);
...
describe("GET /api/LogIn", () => {
  it("should retrieve one user info", async () => {
    console.log("Test Case 2: should retrieve one user info");
...
describe("PUT /api/FeedView", () => {
  it("should update a user info with id", async () => {
    console.log("Test Case 3: should update a user info with id");
...
describe("PUT /api/MyPage/:id", () => {
  it("should update a user info with id", async () => {
    console.log("Test Case 4: should update a user info with id");
    const tempUserId = localStorage.getItem('tempUserId')
    const res = await request(app)
...
describe("DELETE /api/MyPage/:id", () => {
  it("should delete a user info with id", async () => {
    console.log("Test Case 5: should delete a user info with id"); 
    const tempUserId = localStorage.getItem('tempUserId')
    const res = await request(app)
